...
new Vue({
    ...
    watch: {
        question: function question(_question) {
            var answers = this.fetchAnswers(_question);
            this.answers = this.formatAnswers(answers);
        }
    },

    methods: {
        formatAnswers: function formatAnswers(answers) {
            var formatedAnswers = [];
...
},{"vue":3}],5:[function(require,module,exports){
'use strict';
